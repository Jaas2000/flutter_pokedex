...
DetailSpecies detailSpeciesFromJson(String str) => DetailSpecies.fromJson(json.decode(str));

String detailSpeciesToJson(DetailSpecies data) => json.encode(data.toJson());
